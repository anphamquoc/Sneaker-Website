  ...
  return (
    <div className="w-full pt-32 flex flex-col items-center">
      <Breadcrumb
        ...
        breadcrumbName="Tài khoản của bạn"
      />
      <div className="w-3/5 flex flex-col gap-5" id="accordionExample">
        {user.loading ? (
          ...
          <>
            ...
            >
              <div className="accordion-body py-4 px-5 divide-y-2">
                <div className="mb-5 text-lg font-normal">
                  <h4 className="font-bold">THÔNG TIN TÀI KHOẢN CỦA BẠN</h4>
            ...
            >
              <div className="accordion-body py-4 px-5 divide-y-2">
                <div className="mb-5 text-lg font-normal">
                  <h4 className="font-bold">THAY ĐỔI MẬT KHẨU</h4>
            ...
            <Link className="px-5" to={"/favourite"}>
